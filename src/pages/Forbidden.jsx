  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center p-6">
      <div className="max-w-md w-full bg-surface-container-lowest border border-outline-variant p-8 rounded-2xl shadow-sm text-center">
        <div className="w-16 h-16 mx-auto rounded-2xl bg-error-container/20 text-error flex items-center justify-center mb-4">
          <span className="material-symbols-outlined text-4xl">block</span>
        </div>
        <h1 className="font-headline-lg text-headline-lg text-on-surface mb-2">Access Denied (403)</h1>
        <p className="font-body-md text-on-surface-variant mb-6 text-sm leading-relaxed">
          You do not have the required permissions to view this clinical module. If you require access, please contact your hospital system administrator.
        </p>
        <Link
          to="/dashboard"
